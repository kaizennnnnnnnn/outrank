    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          {EMBERS.map((p, i) => (
            <motion.div
              ...
              style={{
                ...
                background: i % 3 === 0 ? '#fee2e2' : i % 2 === 0 ? '#ef4444' : '#dc2626',
                boxShadow: `0 0 ${i % 3 === 0 ? 10 : 6}px ${i % 2 === 0 ? '#ef4444' : '#dc2626'}`,
              }}
            />
          ))}
          ...
          {/* Expanding heat rings — three of them, staggered, all red */}
          <motion.div
          ...
          <motion.div
            ...
            className="absolute w-24 h-24 rounded-full border border-red-400/25"
          />
            ...
            {LETTERS.map((l, i) => (
              <motion.span
                ...
                className={
                  ...
                  (l.gradient
                    ? 'text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-500 to-red-400'
                    : 'text-white')
                }
              >
                {l.char}
