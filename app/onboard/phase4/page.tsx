...
/**
 * Phase 4 placeholder — personalization probes (improvement cadence,
 * struggles, energy, statements, insight cards, "path to building",
 * "see real progress") build next session.
 */
export default function OnboardPhase4PlaceholderPage() {
  return (
    <div className="min-h-screen bg-[#08080f] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-slate-400 max-w-sm mt-3 text-sm leading-relaxed">
        Personalization — improvement cadence, struggles, energy, insight cards. Coming up.
      </p>
      <Link
        href="/welcome"
