...
/**
 * Phase 8 placeholder — setup loader (3 progress bars filling in
 * sequence) + Body Constellation explainer + signup (Google / email)
 * + welcome animation. Built next session.
 */
export default function OnboardPhase8PlaceholderPage() {
  return (
    <div className="min-h-screen bg-[#08080f] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-slate-400 max-w-sm mt-3 text-sm leading-relaxed">
        Setup loader, Body Constellation, signup. Coming up.
      </p>
      <Link
        href="/welcome"
